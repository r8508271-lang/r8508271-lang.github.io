# SweepSimple3DEnv (variable object count)

A 3D task where the robot must sweep objects that are spread out on the floor into different regions around fixtures in the room.
...
| --- | --- | --- |
| mujoco_drawer | pos | kitchen_cooking_area_drawer_s0c1, kitchen_cooking_area_drawer_s1c1, kitchen_island_drawer_s0c0, kitchen_island_drawer_s0c1, kitchen_island_drawer_s0c2, kitchen_island_drawer_s1c0, kitchen_island_drawer_s1c1, kitchen_island_drawer_s1c2, kitchen_left_side_drawer_s0c1, kitchen_left_side_drawer_s1c1 |
| mujoco_fixture | x, y, z, qw, qx, qy, qz | kitchen_cooking_area, kitchen_cooking_area_upper, kitchen_island, kitchen_left_corner, kitchen_left_side |
| mujoco_movable_object | x, y, z, qw, qx, qy, qz, vx, vy, vz, wx, wy, wz, bb_x, bb_y, bb_z | wiper_0, cube_0, cube_1, ... |
...
The count-defining objects are named `cube_0`, `cube_1`, ... and their number changes per episode.
