# ConstrainedCupboard3DEnv (variable object count)
...
| --- | --- | --- |
| mujoco_fixture | x, y, z, qw, qx, qy, qz | cupboard_0, cupboard_1, cupboard_2, cupboard_3, cupboard_4, cupboard_5 |
| mujoco_movable_object | x, y, z, qw, qx, qy, qz, vx, vy, vz, wx, wy, wz, bb_x, bb_y, bb_z | cuboid_0, cuboid_1, ... |
...
The count-defining objects are named `cuboid_0`, `cuboid_1`, ... and their number changes per episode.
