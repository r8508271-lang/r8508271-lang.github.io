# Transport3DEnv (variable object count)
...
| --- | --- | --- |
| Kinematic3DCuboid | pose_x, pose_y, pose_z, pose_qx, pose_qy, pose_qz, pose_qw, grasp_active, object_type, half_extent_x, half_extent_y, half_extent_z | box0, table, cube0, cube1, ... |
