# SortClutteredBlocks3DEnv (variable object count)

A 3D task where the robot must sort a pile of objects into different receptacles based on their color. The objects may be initially in contact with each other.
...
| --- | --- | --- |
| mujoco_fixture | x, y, z, qw, qx, qy, qz | table_1 |
| mujoco_movable_object | x, y, z, qw, qx, qy, qz, vx, vy, vz, wx, wy, wz, bb_x, bb_y, bb_z | bin_blue, bin_green, bin_red, bin_yellow, cube0, cube1, ... |
