# Motion2DEnv (variable object count)
...
| rectangle | x, y, theta, static, color_r, color_g, color_b, z_order, width, height | obstacle0, obstacle1, ... |
| target_region | x, y, theta, static, color_r, color_g, color_b, z_order, width, height | target_region |

The count-defining objects are named `obstacle0`, `obstacle1`, ... and their number changes per episode.
